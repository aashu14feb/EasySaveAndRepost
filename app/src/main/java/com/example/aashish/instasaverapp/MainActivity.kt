...
import com.example.aashish.instasaverapp.ui.adapter.CustomPagerAdapter
...
import com.example.aashish.instasaverapp.utils.Util.shareImageTask
...
class MainActivity : AppCompatActivity() {
    ...
    fun saveImage(context: Context) {
        Nammu.askForPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE, object : PermissionCallback {
            override fun permissionGranted() {
                ImageDownloadTask(this@MainActivity).execute(imagedata.url, imagedata.name, imagedata.video_url, imagedata.is_Video.toString())
            }
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.i("InstaSaver", "Service onDestroy now")
